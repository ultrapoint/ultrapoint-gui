...
WALLET_ROOT=$$PWD/ultrapoint

CONFIG += c++11

# cleaning "auto-generated" ultrapoint directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently ultrapoint has an issue with "static" build and linunwind-dev,
...
DISTFILES += \
    notes.txt \
    ultrapoint/src/wallet/CMakeLists.txt \
    components/MobileHeader.qml


# windows application icon
RC_FILE = ultrapoint-gui.rc
