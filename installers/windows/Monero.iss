...
; Filename: "{app}\ultrapoint-wallet-gui.exe"; Description: "Run GUI Wallet now"; Flags: postinstall nowait skipifsilent
...
Root: HKCU; Subkey: "Software\ultrapoint-project"; Flags: uninsdeletekeyifempty
Root: HKCU; Subkey: "Software\ultrapoint-project\ultrapoint-gui"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\ultrapoint-project\ultrapoint-gui"; ValueType: string; ValueName: "daemonFlags"; ValueData: {code:DaemonFlags};
